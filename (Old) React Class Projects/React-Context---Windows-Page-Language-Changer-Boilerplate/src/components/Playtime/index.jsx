...
const playtimeContent = {
  ...
  MS: {
    heading: "Masa bermain. Bila-bila masa",
    description:
      "Windows membawa permainan ke tahap baharu dengan keupayaan grafik yang menyaingi realiti. Temui permainan kegemaran anda yang seterusnya dengan Xbox GamePass, memberikan anda akses kepada lebih 100 permainan berkualiti tinggi.",
  },
  ZH: {
    heading: "游戏时间。随时随地",
    description:
      "Windows 将游戏提升到一个全新的水平，其图形性能可媲美现实。通过 Xbox GamePass 发现您下一个最喜欢的游戏，您可以访问超过 100 款高质量游戏。",
  },
};
    ...
    {(value) => {
      const getPlaytimeData = (activeLanguage) => {
        switch (activeLanguage) {
          ...
          case "MS":
            return playtimeContent.MS;
          case "ZH":
            return playtimeContent.ZH;
          default:
            return null;
        }
      };
